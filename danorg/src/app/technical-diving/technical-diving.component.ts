...
@Component({
  selector: 'app-technical-diving',
  templateUrl: './technical-diving.component.html',
  styleUrls: ['./technical-diving.component.css']
})
export class TechnicalDivingComponent implements OnInit {
  ...
  addFeedback(data:any): Observable<any> {
		return this.http.post<any>(this.apiUrl+"addTechnicalDiving", data);	      		    							
	}  
