...
@Component({
	selector: "app-danshop-header",
	templateUrl: "./danshop-header.component.html",
	styleUrls: ["./danshop-header.component.css"],
})
export class DanshopHeaderComponent implements OnInit{
