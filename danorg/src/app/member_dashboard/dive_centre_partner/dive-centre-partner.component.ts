...
@Component({
  selector: 'app-dive-centre-partner',
  templateUrl: './dive-centre-partner.component.html',		
  styleUrls: ['./dive-centre-partner.component.css']
})   

export class DiveCentrePartner implements OnInit {   
  ...
  private apiUrl = 'https://danshopapi.devworktdmc.com/dive_centre_partner/add';  			
  private appUrl = 'https://danshopapi.devworktdmc.com/dive_centre_partner/update';    		
  ...
  ngOnInit(): void {
	...
	if ((this.router.url == '/dive-centre-partner') && ((this.userAccess !='paid') || (this.userRenew ==='renew')))      
	{
  ...
  onEdit(id:any)
  {
	  this.http.get('https://danshopapi.devworktdmc.com/dive_centre_partner/edit/'+id).subscribe((response) => {
		  this.data = response;   	    	    		  
  ...
  getProvider(id:any) { 
	  this.http.get('https://danshopapi.devworktdmc.com/dive_centre_partner/get_members/'+id).subscribe((response) => {
