(function (global, factory) {
	...
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', 'rxjs', '@angular/platform-browser', '@angular/common'], factory) :
	(factory((global.ngxNotify = {}),global.ng.core,global.rxjs,global.ng.platformBrowser,global.ng.common));
...
var NotifyService = /** @class */ (function () {
        ...
        if (to) {
            ...
            notify.id = notify.id
                ...
                : Math.random()
                    .toString(36)
                    .substring(3);
            notify.click = new core.EventEmitter();
        }
    ...
    NotifyService.ctorParameters = function () { return [
        ...
        { type: core.Injector, },
        { type: NotifyServiceConfig, decorators: [{ type: core.Optional },] },
    ]; };
...
exports.NotifyHolderComponent = NotifyHolderComponent;
exports.NotifyComponent = NotifyComponent;
exports.NotifyServiceConfig = NotifyServiceConfig;
exports.NotifyService = NotifyService;
exports.NotifyPushService = NotifyPushService;
