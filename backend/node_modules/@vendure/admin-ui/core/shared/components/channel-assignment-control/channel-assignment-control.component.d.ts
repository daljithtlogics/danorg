...
export declare class ChannelAssignmentControlComponent implements OnInit, ControlValueAccessor {
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<ChannelAssignmentControlComponent, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<ChannelAssignmentControlComponent, "vdr-channel-assignment-control", never, { "multiple": { "alias": "multiple"; "required": false; }; "includeDefaultChannel": { "alias": "includeDefaultChannel"; "required": false; }; "disableChannelIds": { "alias": "disableChannelIds"; "required": false; }; }, {}, never, never, false, never>;
}
