...
export declare class OrderProcessGraphComponent implements OnInit, OnChanges, AfterViewInit {
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<OrderProcessGraphComponent, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<OrderProcessGraphComponent, "vdr-order-process-graph", never, { "states": { "alias": "states"; "required": false; }; "initialState": { "alias": "initialState"; "required": false; }; }, {}, never, never, false, never>;
}
