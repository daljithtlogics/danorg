...
let RefundEntityResolver = class RefundEntityResolver {
    ...
    async lines(ctx, refund) {
        ...
        return (_b = (_a = payment.refunds.find(r => (0, index_1.idsAreEqual)(r.id, refund.id))) === null || _a === void 0 ? void 0 : _a.lines) !== null && _b !== void 0 ? _b : [];
    }
};
__decorate([
...
RefundEntityResolver = __decorate([
    ...
    __metadata("design:paramtypes", [index_2.PaymentService])
