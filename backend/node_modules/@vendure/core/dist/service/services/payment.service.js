...
let PaymentService = class PaymentService {
    ...
    async createRefund(ctx, input, order, selectedPayment) {
        ...
        const refundMax = (_b = (_a = orderWithRefunds.payments) === null || _a === void 0 ? void 0 : _a.map(p => p.amount - paymentRefundTotal(p)).reduce((sum, amount) => sum + amount, 0)) !== null && _b !== void 0 ? _b : 0;
        ...
        do {
            ...
            const createRefundResult = paymentMethod && handler
                ? await handler.createRefund(ctx, input, total, order, paymentToRefund, paymentMethod.handler.args, paymentMethod)
                : false;
            ...
            refundOutstanding = refundTotal - (0, shared_utils_1.summate)(refundsCreated, 'total');
