...
export declare class PromotionService {
    ...
    removePromotionsFromChannel(ctx: RequestContext, input: RemovePromotionsFromChannelInput): Promise<import("../../index").Translated<Promotion>[]>;
    /**
     * @description
    ...
    getActivePromotionsInChannel(ctx: RequestContext): Promise<import("../../index").Translated<Promotion>[]>;
