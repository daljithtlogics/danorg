...
let CustomerService = class CustomerService {
    ...
    findAll(ctx, options, relations = []) {
        ...
        const hasPostalCodeFilter = !!((_a = options === null || options === void 0 ? void 0 : options.filter) === null || _a === void 0 ? void 0 : _a.postalCode);
    ...
    async deleteAddress(ctx, id) {
        ...
        this.eventBus.publish(new customer_address_event_1.CustomerAddressEvent(ctx, deletedAddress, 'deleted', id));
        return true;
    }
