...
@Component({
    selector: 'addprofessional',			
    templateUrl: './addprofessionalmembership.component.html',		  				  								
	styleUrls: ['./addprofessionalmembership.component.css'],           	   	            
    standalone: true,
    imports: [SharedModule],		
})
export class AddProfessionalMembershipComponent implements OnInit {     
	  greeting = 'add professional';	 					  
	  id:any; 
	  broker_id:any; 
	  profForm:any; 	     
	  form!: FormGroup;    
	  ...
	  staffs:any; 
	  data: any; 	  
	  private apiUrl = 'https://danshopapi.devworktdmc.com/professional/add'; // Replace this with your API endpoint
