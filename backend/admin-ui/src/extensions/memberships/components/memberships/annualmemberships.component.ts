...
@Component({
  selector: 'annual',
  templateUrl: './annualmemberships.component.html',					
...
export class AnnualmembershipsComponent implements OnInit 	
{
  ...
  getData(pageNo: any) { 	
    ...
    this.http.get(`https://danshopapi.devworktdmc.com/annual/get_members?pageNumber=${this.currentIndex}&recordsPerPage=${this.pageSize}&search=${this.inputName}`).subscribe((response) => {
