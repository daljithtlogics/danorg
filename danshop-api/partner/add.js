...
app.post('/api/partner/add', async (req, res) => {			
  ...
  try {
    ...
    const sqlQuery = `INSERT INTO partner_members (firstName, lastName, mobile,password, email, start_date, member_no, status) VALUES ('${data.firstName}', '${data.lastName}', '${data.mobile}', '${hashedPassword}', '${data.email}' , '${currentDate}', '${memberNO}', 1)`;
