  ...
  if(result.length==1)  
  {
	  try {  
		...
		{	
			...
			const sqlQuery = `UPDATE membership SET title1='${infoTitle}',fname1='${firstName}',sname1='${surName}',passport1='${infoPassport}',address1='${infoAddress1}',address2='${infoAddress2}',city1='${infoCity}',province1='${infoProvince}',postcode1='${postCode}', country1='${infoCountry}',telephone1='${telHome}',telephone2='${telWork}',cellphone1='${cellPhone}',email1='${infoEmail}',fax='${fax}',medical_aid='${medicalAid}',medical_aid_no='${medicalAidNo}',aid_dependent='${medicalAidDep}',dob1='${infoDob}' WHERE id=${id}`;   		
		...
		{						     
			...
			const sqlQuery = `UPDATE membership SET membertype='${memberType}',broker_id='${broker}',agency='${agency}',work_diver='${workDiver}',qualification='${qualification}' WHERE id=${id}`;   		
